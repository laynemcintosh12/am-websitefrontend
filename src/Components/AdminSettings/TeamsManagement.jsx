    ...
    <div>
      {isEditing ? (
        ...
        <div className="space-y-4">
          {/* Search and Create controls - Mobile optimized */}
          <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4">
            ...
            <button
              ...
              className={`w-full sm:w-auto px-4 py-3 sm:py-2 rounded-lg transition-colors ${
                isDarkMode
          ...
          <div className="grid grid-cols-1 gap-4">
            {filteredTeams.map((team) => (
              ...
              >
                <div className={`px-4 sm:px-6 py-4 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {/* Team members with improved mobile touch targets */}
